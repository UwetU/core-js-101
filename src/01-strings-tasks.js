...
function encodeToRot13(str) {
  ...
  const index = (x) => inputAlphabet.indexOf(x);
  const translate = (x) => (index(x) > -1 ? outputAlphabet[index(x)] : x);
  // разбиваем строку на массивы к каждому массиву применяем map и собираем строку обратно
